...
export default function MessagesPage() {
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      ...
      sender: "owner",
      content:
        "Máy lạnh có vấn đề gì vậy bạn? Bạn có thể mô tả chi tiết không?",
    ...
    },
    {
      ...
      sender: "tenant",
      content:
        "Máy lạnh không thổi lạnh từ 2 ngày nay ạ. Tôi đã thử điều chỉnh nhiệt độ nhưng vẫn không được.",
    ...
    },
    {
      ...
      sender: "owner",
      content:
        "Tôi sẽ liên hệ thợ sửa chữa và sẽ có mặt vào chiều mai. Bạn có ở nhà không?",
              ...
              >
                <div
                  className={`max-w-xs lg:max-w-md ${
                    message.sender === "tenant" ? "order-2" : "order-1"
                  }`}
                >
