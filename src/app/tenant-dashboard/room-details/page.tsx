...
const mockRoomDetails = {
  ...
  fullDescription:
    "Phòng trọ hiện đại, thoáng mát với đầy đủ tiện nghi. Vị trí thuận lợi gần trường đại học, siêu thị và các tiện ích công cộng. Phòng được trang bị đầy đủ nội thất cao cấp, internet tốc độ cao và hệ thống an ninh 24/7.",
  amenitiesDetailed: [
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment:
        "Phòng rất sạch sẽ, chủ trọ thân thiện. Vị trí thuận lợi gần trường.",
      date: "2024-01-15",
      avatar: "👨",
    },
    {
      ...
      rating: 4,
      comment:
        "Phòng đẹp, đầy đủ tiện nghi. Chỉ có điều internet đôi khi chậm.",
      date: "2024-01-10",
      avatar: "👩",
    },
  ],
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-600">
                  Chi tiết phòng {mockRoomDetails.number}
                </span>
              </div>
              <Link
                href="/tenant-dashboard"
                  ...
                  <div className="flex items-center justify-center mt-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <StarIcon
                        key={star}
                        className={`h-4 w-4 ${
                          star <= Math.floor(mockRoomDetails.landlord.rating)
                            ? "text-yellow-400 fill-current"
                            : "text-gray-300"
                        }`}
                      />
                    ...
                    <span className="ml-2 text-sm text-gray-600">
                      {mockRoomDetails.landlord.rating} (
                      {mockRoomDetails.landlord.totalReviews} đánh giá)
                    </span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900">
                      {mockRoomDetails.landlord.phone}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <ChatBubbleLeftRightIcon className="h-5 w-5 text-gray-400 mr-3" />
                    <span className="text-gray-900">
                      {mockRoomDetails.landlord.email}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <ClockIcon className="h-5 w-5 text-gray-400 mr-3" />
                    <span className="text-gray-600">
                      {mockRoomDetails.landlord.responseTime}
                    </span>
                  </div>
                </div>
