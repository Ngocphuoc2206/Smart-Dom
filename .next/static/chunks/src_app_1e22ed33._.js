...
const useChatConnection = (userId)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useChatConnection.useEffect": ()=>{
            const newConnection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$microsoft$2f$signalr$2f$dist$2f$esm$2f$HubConnectionBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HubConnectionBuilder"]().withUrl(`https://localhost:7257/chatHub?userId=${userId}`) // truyền userId từ FE
            ...
            newConnection.start().then({
                ...
                "useChatConnection.useEffect": (err)=>console.log("Connection failed: ", err)
            }["useChatConnection.useEffect"]);
            return ({
                "useChatConnection.useEffect": ()=>{
                    newConnection.stop();
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    const conn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useChatConnection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createChatConnection"])(userId);
    conn.start().then(()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesPage.useEffect": ()=>{
            ...
            conn.start().then({
                ...
                "MessagesPage.useEffect": (err)=>{
                    console.error("❌ Kết nối thất bại", err);
                    alert("kết nối that bai");
                }
            }["MessagesPage.useEffect"]);
            conn.onclose({
                "MessagesPage.useEffect": (error)=>{
            ...
            conn.onreconnected({
                "MessagesPage.useEffect": (connectionId)=>{
...
_s(MessagesPage, "alqUp6cM9kmvsT7Ki1V1j2btfWQ=", false, function() {
    return [
...
//# sourceMappingURL=src_app_1e22ed33._.js.map