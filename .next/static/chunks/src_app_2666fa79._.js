...
"[project]/src/app/hooks/useChatTenantWithOwner.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const useChatConnection = (userId, onMessageReceived)=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useChatConnection.useEffect": ()=>{
            if (!userId) return;
            const conn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$microsoft$2f$signalr$2f$dist$2f$esm$2f$HubConnectionBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HubConnectionBuilder"]().withUrl(`https://localhost:7257/chatHub?userId=${userId}`).withAutomaticReconnect().build();
            conn.start().then({
                "useChatConnection.useEffect": ()=>{
                    console.log("✅ SignalR connected");
                    conn.on("ReceiveMessage", onMessageReceived);
                    setConnection(conn);
                }
            }["useChatConnection.useEffect"]).catch({
                "useChatConnection.useEffect": (err)=>{
...
_s(useChatConnection, "0zrM3Z2qcAsIAygoKW672o4jWrA=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useChatTenantWithOwner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/hooks/useChatTenantWithOwner.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function MessagesPage() {
    ...
    const receiverId = "24"; // temporary hardcoded for testing
    // Sử dụng hook kết nối
    const connection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useChatTenantWithOwner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatConnection"])(userId, {
        "MessagesPage.useChatConnection[connection]": (msg)=>{
            setMessages({
                "MessagesPage.useChatConnection[connection]": (prev)=>[
                        ...prev,
                        msg
                    ]
            }["MessagesPage.useChatConnection[connection]"]);
        }
    }["MessagesPage.useChatConnection[connection]"]);
...
_s(MessagesPage, "ztcRiPUIct75SiyO35vFoNs0k+U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2f$useChatTenantWithOwner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatConnection"]
    ];
});
_c = MessagesPage;
var _c;
...
//# sourceMappingURL=src_app_2666fa79._.js.map