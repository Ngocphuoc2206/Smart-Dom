...
function TenantDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TenantDashboard.useEffect": ()=>{
            ...
            let isMounted = true;
            const connection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$microsoft$2f$signalr$2f$dist$2f$esm$2f$HubConnectionBuilder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HubConnectionBuilder"]().withUrl(`https://localhost:7257/hub/notifications?userId=${user.idUser}`).withAutomaticReconnect().build();
            connection.start().then({
                "TenantDashboard.useEffect": ()=>{
                    if (!isMounted) return;
                    console.log("SignalR Connected");
                    connection.on("ReceiveNotification", {
                        "TenantDashboard.useEffect": (message)=>{
                            console.log("Nhận thông báo:", message);
                            setNotifications({
                                "TenantDashboard.useEffect": (prev)=>[
                                        ...prev,
                                        message
                                    ]
                            }["TenantDashboard.useEffect"]);
                            setUnreadCount({
                                "TenantDashboard.useEffect": (prev)=>prev + 1
                            }["TenantDashboard.useEffect"]);
                        }
                    }["TenantDashboard.useEffect"]);
                }
            }["TenantDashboard.useEffect"]).catch({
                "TenantDashboard.useEffect": (error)=>{
            ...
            return ({
                "TenantDashboard.useEffect": ()=>{
                    ...
                    const stopConnection = {
                        "TenantDashboard.useEffect.stopConnection": async ()=>{
                            try {
                    ...
                    }["TenantDashboard.useEffect.stopConnection"];
                    stopConnection();
                }
            })["TenantDashboard.useEffect"];
        }
...
_s(TenantDashboard, "rDwpsdfN2Q0AZv/6cMDK/z+Gv0w=", false, function() {
    return [
...
//# sourceMappingURL=src_app_a4558888._.js.map