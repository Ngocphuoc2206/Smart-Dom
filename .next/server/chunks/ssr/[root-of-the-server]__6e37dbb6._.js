...
;
const metadata = {
    title: "SmartDorm - Hệ thống quản lý nhà trọ thông minh",
    description: "Số hóa và tự động hóa quy trình quản lý nhà trọ. Giảm thời gian, chi phí vận hành cho chủ trọ. Tăng sự tiện lợi, minh bạch cho khách thuê."
};
